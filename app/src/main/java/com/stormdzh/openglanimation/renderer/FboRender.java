...
public class FboRender {
    ...
    public void onCreate() {
        String vertexSource = ShaderUtil.readRawText(context, R.raw.vertex_pic_shader);
        String fragmentSource = ShaderUtil.readRawText(context, R.raw.fragment_pic_shader);
