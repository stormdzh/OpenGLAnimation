 ...
 */
public class RotateRenderer implements GLSurfaceView.Renderer {
    ...
    public RotateRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        if (program > 0) {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.img_chelun);
...
//        GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT);
        ...
        if (System.currentTimeMillis() - lastTime > 50) {
            ...
            Matrix.rotateM(matrix, 0, setp++, 0, 0, 1);
        }
